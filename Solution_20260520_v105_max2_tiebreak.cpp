...
inline EvalMetrics collect_metrics(int m){
    ...
    for(int leaf=0;leaf<g_l;++leaf)
        for(int pk=0;pk<g_p;++pk){
            ...
            int fo=global_out[leaf][pk]+mo;
            int fi=global_in[leaf][pk]+mi;
            if(fo>em.fg){em.future_max2=em.fg;em.fg=fo;}
            else if(fo>em.future_max2)em.future_max2=fo;
            if(fi>em.fg){em.future_max2=em.fg;em.fg=fi;}
            else if(fi>em.future_max2)em.future_max2=fi;
...
inline int better_metrics(const EvalMetrics &a,const EvalMetrics &b){
    ...
    if(a.future_max2!=b.future_max2) return a.future_max2<b.future_max2;
