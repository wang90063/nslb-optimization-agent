...
void solve_job(){
    ...
    if(!huge_job){
        // Explore a bit more order diversity for the local-first family.
        // On some proxy-like overflow jobs, plain/reversed local-first already
        // wins; shuffled variants may reach a lower jm/fg combination.
        if(g_p<=16){
