...
inline int better_primary_metrics(const EvalMetrics &a,const EvalMetrics &b){
    if(a.score_jm!=b.score_jm) return a.score_jm<b.score_jm;
    if(a.score_fg!=b.score_fg) return a.score_fg<b.score_fg;
    return 0;
}
...
void solve_job(){
    ...
    if(better_primary_metrics(eq_s2, base_s2)) TRY_STRATEGY();
    ...
    if(better_primary_metrics(eq_s3, base_s3)) TRY_STRATEGY();
    ...
    if(better_primary_metrics(eq_s4, base_s4)) TRY_STRATEGY();
    ...
    if(better_primary_metrics(eq_s6, base_s6)) TRY_STRATEGY();
    ...
    if(better_primary_metrics(eq_s11, base_s11)) TRY_STRATEGY();
