...
void solve_job(){
    ...
    // S6e1: stronger-global eq-rank. This only changes equal-cost port ties,
    // so it can improve global evolution without adding a new selector gate.
    ...
    // S11e: eq-rank variant of the global-dominant family.
