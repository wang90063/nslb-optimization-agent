    ...
    for(int iter=0;iter<2;++iter){
        ...
        for(int sl=0;sl<g_l;++sl){
            ...
            for(int py=0;py<g_p;++py){
                if(px==py||cyc_edge_cnt[px][py]==0) continue;
                for(int pz=0;pz<g_p;++pz){
                    ...
                    int cb_a0=card_cbtphsc(ca,m),cb_b0=card_cbtphsc(cbb,m),cb_c0=card_cbtphsc(cc,m);
                    unsigned int mk;
                    ...
                    fl_port[bc]=px;
                    int cb_a1=card_cbtphsc(ca,m),cb_b1=card_cbtphsc(cbb,m),cb_c1=card_cbtphsc(cc,m);
                    int net=(cb_a0-cb_a1)+(cb_b0-cb_b1)+(cb_c0-cb_c1);
                    if(net>0){improved=1;}
                    else{
                      mk=ma;while(mk){int ph=__builtin_ctz(mk);
