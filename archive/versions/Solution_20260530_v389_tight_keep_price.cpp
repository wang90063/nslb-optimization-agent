...
void solve_job(){
    ...
    if(time_tight){
        // On late p32/r4 jobs, keep the cheapest price-aware candidates alive.
        // These are the most relevant branches for the candidate CB window and
        // much cheaper than the full post-S3 portfolio.
