...
void solve_job(){
    ...
    if(job_work>150000) allow_extra_pc_chain=0;
    else if(job_work>120000&&!(g_p>=16&&m>=17&&fl_count<=7000)) allow_extra_pc_chain=0;
    if(job_work>80000&&fl_count>7000) allow_extra_pc_chain=0;
