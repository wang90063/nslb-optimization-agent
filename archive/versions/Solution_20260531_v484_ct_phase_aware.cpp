    ...
    for(int iter=0;iter<3;++iter){
        ...
        for(int fi=0;fi<fl_count;++fi){
            ...
            for(int py=0;py<g_p;++py){
                ...
                int new_max_out_py=ct_max_out[sl][py];
                int new_max_in_py=ct_max_in[dl][py];
                while(m3){int ph=__builtin_ctz(m3);
                    int no=out_load[sl][py][ph]+1;
                    if(no>new_max_out_py) new_max_out_py=no;
                    int ni=in_load[dl][py][ph]+1;
                    if(ni>new_max_in_py) new_max_in_py=ni;
                    m3&=m3-1;}
                if(new_max_out_py>ct_max_out[sl][px]) continue;
                if(new_max_in_py>ct_max_in[dl][px]) continue;
                ...
                int new_ct_sl_py=(global_out[sl][py]+new_max_out_py>g_r)?(global_out[sl][py]+new_max_out_py-g_r):0;
                int new_ct_dl_py=(global_in[dl][py]+new_max_in_py>g_r)?(global_in[dl][py]+new_max_in_py-g_r):0;
                int old_ct_sl_py=(global_out[sl][py]+ct_max_out[sl][py]>g_r)?(global_out[sl][py]+ct_max_out[sl][py]-g_r):0;
                int old_ct_dl_py=(global_in[dl][py]+ct_max_in[dl][py]>g_r)?(global_in[dl][py]+ct_max_in[dl][py]-g_r):0;
                int ct_delta=(cur_ct_sl-new_ct_sl_px)+(cur_ct_dl-new_ct_dl_px)+(old_ct_sl_py-new_ct_sl_py)+(old_ct_dl_py-new_ct_dl_py);
