...
void solve_job(){
    ...
    // Pressure-order candidates: sort heavy flows on hot leaves first so the
    // initial solution spends the low-pressure ports on structurally harder
    // traffic instead of only relying on later post-pass reshaping.
